...
fn default_bindings() -> Vec<KeyBinding> {
    let mut b = vec![
        ...
        KeyBinding { mods: vec![], key: "XF86MonBrightnessUp".into(), action: BindingAction::Spawn("/home/mulpin/.local/bin/expiecustwm-brightness up".into()) },
        KeyBinding { mods: vec![], key: "XF86MonBrightnessDown".into(), action: BindingAction::Spawn("/home/mulpin/.local/bin/expiecustwm-brightness down".into()) },
